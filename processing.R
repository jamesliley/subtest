...
z_scores=function(X,Ya,Yd,Ca=NULL,Cd=NULL,signed=TRUE) {
...
z_ad=cbind(zd_scores(X,Yd,Cd,signed),za_scores(X,Ya,Ca,signed))
z_ad
}
...
za_scores=function(X,Ya,Ca=NULL,signed=TRUE) {
...
##' @examples
##' # See examples for function z_scores
zd_scores=function(X,Ya,Ca=NULL,signed=TRUE) {
